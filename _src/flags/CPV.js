  ...
  ({ color = 'currentColor', size = 32, ...rest }, ref) => {
    return (
      ...
      >
        <defs>
          <clippath id="a">
            <path fillOpacity=".7" d="M-123.4 0h682.6v512h-682.6z"></path>
          </clippath>
        </defs>
        <g
          fillRule="evenodd"
        ...
        >
          <path fill="#fff" d="M-123.4 233H723v206h-846.5z"></path>
          <path
            fill="#081873"
            d="M-122.8 0h846v256.6h-846zm.3 385.9h852.1V512h-852.1z"
          ></path>
          <path fill="#de3929" d="M-122.5 302.6h846v39.6h-846z"></path>
          <path
            fill="#ffce08"
