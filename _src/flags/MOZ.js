    ...
    return (
      ...
      >
        ...
        <g clipPath="url(#a)" transform="scale(.9375)">
          <path fill="#009a00" fillRule="evenodd" d="M0 0h768v160H0z"></path>
          <path fill="#fff" fillRule="evenodd" d="M0 160h768v16H0z"></path>
          <path fillRule="evenodd" d="M0 176h768v160H0z"></path>
          <path fill="#fff" fillRule="evenodd" d="M0 336h768v16H0z"></path>
          <path fill="#ffca00" fillRule="evenodd" d="M0 352h768v160H0z"></path>
          <path fill="red" fillRule="evenodd" d="M0 0v512l336-256L0 0z"></path>
          <path
            fill="#ffca00"
            fillRule="evenodd"
