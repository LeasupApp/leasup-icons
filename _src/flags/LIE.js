  ...
  ({ color = 'currentColor', size = 32, ...rest }, ref) => {
    return (
      <svg
        ...
        {...rest}
      >
        <path fill="#002b7f" d="M0 0h640v240H0z"></path>
        <path fill="#ce1126" d="M0 240h640v240H0z"></path>
        <g
          fill="#ffd83d"
          stroke="#000"
          strokeLinecap="round"
        ...
        >
          <g id="a">
            ...
            <circle cx="212.8" cy="113" r="4.9"></circle>
            <circle cx="201.7" cy="110.3" r="4.9"></circle>
            <circle cx="190.4" cy="107.5" r="4.9"></circle>
            <circle cx="179.1" cy="105.6" r="4.9"></circle>
            <circle cx="167.8" cy="104.5" r="4.9"></circle>
            <circle cx="156.8" cy="105.1" r="4.9"></circle>
            <circle cx="146.2" cy="108.7" r="4.9"></circle>
            <circle cx="137.3" cy="115.3" r="4.9"></circle>
            <circle cx="131" cy="124.4" r="4.9"></circle>
            <circle cx="127.9" cy="135.2" r="4.9"></circle>
            <circle cx="128" cy="146.3" r="4.9"></circle>
            <circle cx="130.2" cy="157.2" r="4.9"></circle>
            <path d="m215 119.5-.5 6.5c-12.3-2-29.7-8.8-46-8.8-15 0-26.6 6-26.6 21.2 0 14.9 6.3 28.5 14.7 42.3l-8.7 4c-7.8-15-14.3-28-14.3-45.4 0-14.6 11.5-29 31.3-29 17.5 0 35.4 6 50.1 9.2z"></path>
          </g>
          <use
            href="#a"
            width="100%"
          ...
          ></use>
          <path d="m222 53.1-5.2 9.7 5.2 9.6 5.1-9.6L222 53zm0 24.4-5.2 9.6 5.2 9.7 5-9.8-5.1-9.6zM203.6 75l8.1 5.1 8.1-5.1-8-5.2-8.2 5.2zm20.5 0 8.1 5.1 8.2-5.1-8.2-5.2-8 5.2z"></path>
          <circle cx="222" cy="75.1" r="3.9"></circle>
          <circle cx="222" cy="100" r="10.5"></circle>
          <path
            fill="none"
            strokeWidth="1.5"
          ...
          ></path>
          <path d="M211.8 117.7c-1 17-3 34.5-9.7 47.1l10.8-4.4c3.8-14.3 4.6-32.8 5.7-41.6l-6.8-1.1zm20.4 0-6.9 1.1c1.2 8.8 2 27.3 5.7 41.6l10.8 4.4c-6.6-12.6-8.6-30-9.6-47.1z"></path>
          ...
          <g strokeWidth="1.5">
            ...
            ></path>
            <circle cx="222" cy="114.4" r="3.5"></circle>
            <circle cx="222" cy="122" r="3.7"></circle>
            <circle cx="222" cy="130.2" r="4.1"></circle>
            <circle cx="222" cy="139.3" r="4.7"></circle>
            <circle cx="222" cy="149.4" r="5.1"></circle>
            <path
              fill="#000"
              stroke="none"
