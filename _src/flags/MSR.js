  ...
  ({ color = 'currentColor', size = 32, ...rest }, ref) => {
    return (
      ...
      >
        ...
        ></path>
        <path d="m480 141.5-.3-17.6 14 .1.1 17.5H532l.1 13.7-38.3.2-.3 161.4-13.6.1-.2-161.7-38 .2v-14z"></path>
        <path
          fill="#ff9a08"
          fillRule="evenodd"
          stroke="#000"
        ...
        <g fill="none" stroke="#ffdf00" strokeLinecap="round" strokeWidth="1.8">
          <path strokeWidth=".8" d="m448.5 283 36 41.2"></path>
          <path
        ...
        <g strokeWidth=".4">
          <path d="M500.5 152.7c.8 1 1.7 1 1.8 1.6.2.8.3.8.4 1 .2.2-.4.2-.6 0h-1.4c-.4 0-.8-.5-.6-.5.3-.1.3-.2.2-.4 0-.3.2-.6.4-.7l-.1-.3c-.2-.3-.3-1-.1-.8zM501 151.6a6.4 6.4 0 0 1 3.4 1.6c.7.8.1.6-.2.6s-1-.2-1.4-.6a4.6 4.6 0 0 0-1.9-1.2c-.3 0-.6-.4 0-.4z"></path>
        </g>
