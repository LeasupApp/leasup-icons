  ...
  ({ color = 'currentColor', size = 32, ...rest }, ref) => {
    return (
      ...
      >
        <defs>
          <radialgradient id="a">
            <stop offset=".2" stopColor="#f9f0aa"></stop>
            <stop offset="1" stopColor="#b07e09"></stop>
          </radialgradient>
          <radialgradient
            href="#b"
            id="e"
          ...
          <radialgradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop offset=".3" stopColor="#a50a0a"></stop>
            <stop offset="1" stopColor="#4c0505"></stop>
          </radialgradient>
          <radialgradient
            id="o"
            cx="489.1"
          ...
          <lineargradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop offset=".2" stopColor="#b07e09" stopOpacity="0"></stop>
            <stop offset="1" stopColor="#b07e09"></stop>
          </lineargradient>
          <lineargradient
            id="j"
        ...
        <path fill="#4997d0" d="M0 0h640v480H0Z"></path>
        ...
        <g transform="matrix(.81133 0 0 .8264 -69.4 -8)">
          <g stroke="#24420e">
            ...
            <g fill="#ba1f3e" stroke="#511124" strokeWidth=".2">
              <circle cx="396.8" cy="251.3" r="1.1"></circle>
              <circle cx="405.2" cy="245.1" r="1.1"></circle>
              <circle cx="401.6" cy="241.7" r="1.1"></circle>
              <circle cx="392.5" cy="313.1" r="1.3"></circle>
              <circle cx="395" cy="297.1" r="1.3"></circle>
              <circle cx="408.2" cy="334.5" r="1.3"></circle>
              <circle cx="402.4" cy="336.4" r="1.3"></circle>
              <circle cx="446.7" cy="367.6" r="1.3"></circle>
              <circle cx="449.6" cy="374.7" r="1.3"></circle>
            </g>
          </g>
          <g stroke="#24420e">
            <g fill="none" strokeWidth=".4">
            ...
            <g fill="#ba1f3e" stroke="#511124" strokeWidth=".2">
              <circle cx="564.6" cy="254.9" r="1.1"></circle>
              <circle cx="568.4" cy="266.8" r="1.1"></circle>
              <circle cx="569.8" cy="304.3" r="1.3"></circle>
              <circle cx="564.6" cy="297.3" r="1.3"></circle>
              <circle cx="549.9" cy="337.2" r="1.3"></circle>
              <circle cx="556.2" cy="339.9" r="1.3"></circle>
              <circle cx="513.8" cy="372.3" r="1.3"></circle>
              <circle cx="506.8" cy="377.3" r="1.3"></circle>
              <circle cx="557.1" cy="249.3" r="1.1"></circle>
            </g>
          </g>
