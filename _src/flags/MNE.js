  ...
  ({ color = 'currentColor', size = 32, ...rest }, ref) => {
    return (
      <svg
        ...
        {...rest}
      >
        <path fill="#d3ae3b" d="M0 0h640v480H0z"></path>
        <path fill="#c40308" d="M24 24h592v432H24z"></path>
        <path
          fill="#b96b29"
        ...
        ></path>
        <ellipse cx="312.6" cy="226" fill="#b96b29" rx="1.5" ry="1.4"></ellipse>
        <path
          fill="#b96b29"
        ...
        ></path>
        <circle cx="320" cy="132.8" r=".7" fill="#d4af3a"></circle>
        <path
          fill="#d4af3a"
        ...
        ></path>
        <ellipse cx="320" cy="122.3" fill="#b96b29" rx="2.8" ry="2.7"></ellipse>
        <ellipse cx="320" cy="115.8" fill="#b96b29" rx="2.7" ry="2.6"></ellipse>
        <ellipse cx="320" cy="109.7" fill="#b96b29" rx="2.6" ry="2.5"></ellipse>
        <ellipse cx="320" cy="121.8" fill="#d4af3a" rx="1.5" ry="1.4"></ellipse>
        <circle cx="320" cy="115.4" r="1.4" fill="#d4af3a"></circle>
        <ellipse cx="320" cy="109.2" fill="#d4af3a" rx="1.3" ry="1.2"></ellipse>
        <path
          fill="#b96b29"
        ...
        ></path>
        <ellipse cx="274" cy="158.6" fill="#d4af3a" rx="1.8" ry="1.6"></ellipse>
        <path
          fill="#d4af3a"
        ...
        ></path>
        <path fill="#d4af3a" d="m295.2 143.5 3.2 1.4 3.4-2.4-4-1z"></path>
        <ellipse
          cx="309.2"
          cy="142.1"
          fill="#b96b29"
          ...
          ry="3.1"
        ></ellipse>
        <circle cx="309.2" cy="141.4" r="1.9" fill="#d4af3a"></circle>
        <path
          fill="#d4af3a"
          d="M302.4 131.4c.9.3 2 .2 2 .2s.3-1.4-.5-2.1l-2-1.7-.5-.6-.1 2c0 .8.3 1.9 1.2 2.2z"
        ></path>
        <circle cx="304.2" cy="133" r=".6" fill="#d4af3a"></circle>
        <path
          fill="#d4af3a"
        ...
        ></path>
        <ellipse cx="288.6" cy="135.1" fill="#d4af3a" rx=".7" ry=".5"></ellipse>
        <path
          fill="#d4af3a"
        ...
        ></path>
        <circle cx="285.1" cy="123.2" r="1.3" fill="#d4af3a"></circle>
        <path
          fill="#d4af3a"
        ...
        ></path>
        <circle cx="408.9" cy="311.2" r="2.3" fill="#b96b29"></circle>
        <circle cx="415.5" cy="312.8" r="2.4" fill="#b96b29"></circle>
        <circle cx="434.6" cy="316.9" r="2.4" fill="#b96b29"></circle>
        <circle cx="422.1" cy="314.4" r="2.4" fill="#b96b29"></circle>
        <circle cx="423.8" cy="308.6" r="2.4" fill="#b96b29"></circle>
        <circle cx="425.5" cy="302.9" r="2.4" fill="#b96b29"></circle>
        <circle cx="409.1" cy="310.9" r="1.2" fill="#d4af3a"></circle>
        <circle cx="415.6" cy="312.6" r="1.2" fill="#d4af3a"></circle>
        <circle cx="434.8" cy="316.6" r="1.2" fill="#d4af3a"></circle>
        <circle cx="422.2" cy="314.1" r="1.2" fill="#d4af3a"></circle>
        <circle cx="424" cy="308.4" r="1.2" fill="#d4af3a"></circle>
        <circle cx="425.7" cy="302.6" r="1.2" fill="#d4af3a"></circle>
        <path
          fill="#d4af3a"
        ...
        ></path>
        <path fill="#d4af3a" d="m338.2 142.5 4-1 2.5 2-3.1 1.4z"></path>
        <ellipse
          cx="-330.8"
          cy="142.1"
          fill="#b96b29"
