  ...
  ({ color = 'currentColor', size = 32, ...rest }, ref) => {
    return (
      <svg
        ...
        {...rest}
      >
        <path fill="#3e5eb9" d="M0 0h640v480H0Z"></path>
        <path fill="#ffd900" d="M0 90h640v300H0Z"></path>
        <path fill="#b10c0c" d="M0 120h640v240H0Z"></path>
        <g fill="#ffd900" stroke="#000" transform="translate(-43.2) scale(1.2)">
          <g id="a">
            ...
            <rect
              ...
              ry="2.9"
            ></rect>
            <path d="M471.4 165.7a3 3 0 0 0 2.9-2.8 3 3 0 0 0-2.9-2.9m-2.8 5.7a3 3 0 0 0 2.8-2.8 3 3 0 0 0-2.8-2.9m-2.9 5.7a3 3 0 0 0 2.9-2.8 3 3 0 0 0-2.9-2.9"></path>
          </g>
          <use href="#a" width="100%" height="100%" x="-23.3" y="17.1"></use>
          <rect
            width="485.7"
            height="8.6"
            x="59.8"
        ...
        <g stroke="#fff" transform="translate(-43.2) scale(1.2)">
          <g id="d" strokeWidth="6.9">
            <g id="c">
              ...
              ></path>
              <use href="#b" width="100%" height="100%" y="38.1"></use>
            </g>
            <use href="#c" width="100%" height="100%" x="41.6"></use>
          </g>
        </g>
        <use
          href="#d"
