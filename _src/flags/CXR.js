  ...
  ({ color = 'currentColor', size = 32, ...rest }, ref) => {
    return (
      <svg
        ...
        {...rest}
      >
        <path fill="#0021ad" d="M0 0h640v480H0z"></path>
        <path fill="#1c8a42" d="M0 0h640v480z"></path>
        <circle cx="320" cy="240" r="57.8" fill="#ffc639"></circle>
        <path
          fill="#1c8a42"
        ...
        <g fill="#fff" transform="matrix(.64 0 0 .64 0 80)">
          ...
          ></path>
          <path d="m233.4 335.5-13.8-9.1-13.4 9.6 4.8-15.5-13.6-9.5 16.6-.4 5-15.5 5.6 15.3 16.7-.1L228 320l5.3 15.4z"></path>
          <use href="#a" width="100%" height="100%" x="2.5" y="269.1"></use>
          <use href="#a" width="100%" height="100%" x="-112.1" y="123.2"></use>
          <use href="#a" width="100%" height="100%" x="108.4" y="85"></use>
        </g>
      </svg>
    );
  }
