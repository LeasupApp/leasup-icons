  ...
  ({ color = 'currentColor', size = 32, ...rest }, ref) => {
    return (
      ...
      >
        ...
        <path fill="green" d="M0 0h640v480H0z"></path>
        <circle cx="320" cy="240" r="66.7" fill="#ffe000"></circle>
        <circle cx="340.8" cy="240" r="54.9" fill="green"></circle>
        <circle cx="109.8" cy="173.3" r="69.8" fill="#ffe000"></circle>
        <path
          fill="#802000"
          stroke="#7b3100"
          strokeWidth="1.5"
        ...
        <g fill="#ffe000" transform="translate(0 80) scale(.0635)">
          <use href="#a" width="100%" height="100%" x="7560" y="4200"></use>
          <use href="#a" width="100%" height="100%" x="6300" y="2205"></use>
          <use href="#a" width="100%" height="100%" x="7560" y="840"></use>
          <use href="#a" width="100%" height="100%" x="8680" y="1869"></use>
          <use href="#b" width="100%" height="100%" x="8064" y="2730"></use>
        </g>
      </svg>
    );
  }
