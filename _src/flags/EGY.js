      ...
      >
        ...
        <g fill="#fff" stroke="#c09300" transform="matrix(.8 0 0 .8 -40 0)">
          ...
          <g id="b" fill="none" strokeLinejoin="round" strokeWidth="1.3">
            ...
            ></path>
            <path d="m422.2 319 2.3 5.5 12.4-11.8"></path>
            <path d="m430.8 305 2.6 24.3 7.9-10.4m-3.2 4 4.3 15m1.7-5.5-8.7 13.2m2.7 13.2-2.8-13.2-2.4-13.4-5.9 7.9-2.5-9.1-8.2 8.4 4.1 15.2 5.8-9.4 3.1 9.6 6-9.2"></path>
            <path d="m415 362 5.3-7.5 3.4 11.5 4.8-8 3.1 9.6"></path>
          </g>
          <use
            href="#b"
            width="100%"
          ...
          <g strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.3">
            ...
            ></path>
            <path d="M422.9 363.5c6.4.9 13.6 1.6 19.2.9 3.2 0 5.5 5.5-.9 6.3-5.5.7-14.3 0-19-.8a231 231 0 0 1-18.4-4c-5.6-2.4-1.6-7 1.6-6.4a105.3 105.3 0 0 0 17.5 4zm54.2 0c-6.4.9-13.6 1.6-19 .9-3.4 0-5.7 5.5.7 6.3 5.6.7 14.3 0 19-.8 4-.8 12.8-2.3 18.4-4 5.6-2.4 1.6-7-1.6-6.4a105.2 105.2 0 0 1-17.5 4z"></path>
            <path d="M403 360.4c-4.8-.9-7 4.7-5.5 7.9.7-1.6 4-1.6 4.7-3.2.9-2.4-.7-2.4.9-4.7zm19.2 14.7c0-3.2 3.1-2.8 3.1-6 0-1.5-.8-4-2.4-4a3.4 3.4 0 0 0-3.2 3.2c-.7 3.1 2.5 3.6 2.5 6.8zm22.7-9.1c4.7 0 4.2 6.3 2 9.5 0-2.3-4-3.2-4-4.8 0-2.4 3.6-2.4 2-4.7zm52-5.6c4.9-.9 7.2 4.7 5.6 7.9-.7-1.6-4-1.6-4.7-3.2-.9-2.4.7-2.4-.9-4.7zM478 375c0-3.2-3.2-2.8-3.2-6 0-1.5.8-4 2.4-4a3.4 3.4 0 0 1 3.2 3.2c.7 3.1-2.5 3.6-2.5 6.8zm-23-9c-4.7 0-4.2 6.3-2 9.5 0-2.3 4-3.2 4-4.8 0-2.4-3.6-2.4-2-4.7z"></path>
            <path
              strokeWidth=".9"
          ...
          <g strokeWidth="1.3">
            ...
            ></path>
            <circle cx="448.8" cy="210.7" r="1.2" stroke="none"></circle>
          </g>
        </g>
      </svg>
    );
