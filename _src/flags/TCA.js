  ...
  ({ color = 'currentColor', size = 32, ...rest }, ref) => {
    return (
      <svg
        ...
        {...rest}
      >
        <path fill="#002868" d="M640 480V0H0v480h640z"></path>
        <g fill="none" stroke="#000">
          ...
          <g strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.2">
            ...
            <g fill="#9e540a" transform="matrix(.125 0 0 .125 535 249.6)">
              <g id="b">
                <path d="M-55-233s-70-59-128-99-128-89-128-99c11-8 70 30 151 79 82 50 128 99 128 99zm-5 40s-68-41-135-70c-70-29-175-29-186-39 0-10 122-16 209 19 89 41 135 70 135 70zm-1 68s-74-34-146-50c-70-16-170-10-182-19 0-10 124-30 217 0 94 29 134 49 134 49zm-4 69s-56-38-130-46c-70-7-163 46-175 36 0-10 81-69 182-59 99 10 146 49 146 49zm23-218s-71-65-71-109c0-39 43-99 62-99-10 20-43 60-43 99 0 40 75 89 75 89z"></path>
                <path d="M-42-274s14-65 14-109c0-59-42-113-38-128 15 15 57 59 57 128 0 60-10 89-10 89z"></path>
                <g stroke="none">
                  <use
                    href="#a"
                    width="100%"
                ...
                <path d="M-12 191s-11 57-20 98c-8 41-22 55-39 50-18-4-15-37-8-54s49-103 49-103z"></path>
                <path d="M0 193v100c0 42-10 59-29 58-18-1-22-33-18-52 3-18 28-111 28-111z"></path>
              </g>
              <use
                href="#b"
                width="100%"
              ...
              ></use>
              <g id="c">
                <path d="M0 192c-53-1-58-20-58-20s-7-24-8-39c-1-2-15-32-11-45-5-12-17-41-6-46-5-14-13-30-14-45-4-11-14-35-6-43 0 0-19-40-10-50 0 0-9-39 0-49 0 0 0-40 10-50 0 0 0-39 9-49 0 2 28-55 94-55l-1 85h1z"></path>
                <path
                  fill="none"
            ...
            <g transform="matrix(.125 0 0 .125 485 299.6)">
              <g id="d">
                ...
                ></path>
                <path d="M-99 18c-20 20 4 35-16 59-21 25-2 38-19 60s8 33-11 58c-19 24 4 39-17 59-20 21 4 39-17 61-20 23 4 38-16 58-21 21 3 43-17 63-20 21 4 47-19 71-22 24 4 43-14 61-19 19-2 38-15 51s-15 31-10 39M-60 25c-18 25 10 36-7 56-17 21 7 28-6 52s10 30-7 54 9 43-9 67c-19 24 9 37-8 61-16 25 8 38-7 56-15 19 11 37-8 60-18 22 8 39-7 59-15 21 6 43-7 60-13 16 9 41-10 63-18 22 4 37-7 52s-20 37-9 43"></path>
              </g>
              <use
                href="#d"
                width="100%"
                ...
                transform="scale(-1 1)"
              ></use>
              <path stroke="#009e49" d="M0 712V12"></path>
              <path d="M0 48c-9 39 13 73 0 106-13 32 9 45 2 71-8 26 9 45-2 73s15 50 0 87c-15 36 10 45 0 82-11 42 19 64 0 94s17 37 2 71c-15 33 9 46-2 80"></path>
              <path
                fill="#fcd116"
