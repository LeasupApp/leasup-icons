    ...
    return (
      ...
      >
        ...
        <g clipPath="url(#a)" transform="matrix(1.1722 0 0 1.1426 -2.3 -.1)">
          <path fill="#006400" d="M0 0h840v420H0z"></path>
          <path fill="#ffd200" d="M0 60h840v300H0z"></path>
          <path fill="#d40000" d="M0 120h840v180H0z"></path>
          <path d="M0 180h840v60H0z"></path>
          <path stroke="#000" strokeWidth="20" d="M0 0v420l280-210z"></path>
          <path fill="#fff" d="M0 0v420l280-210z"></path>
          <path
            fill="#d40000"
          ...
          ></path>
          <use href="#b" width="100%" height="100%" x="-20.1" y="-.6"></use>
          <path d="M88 145.3a1.7 1.8 0 0 0-1.6 1.7 1.7 1.8 0 1 0 3.5 0 1.7 1.8 0 0 0-1.9-1.7zm.1.6a1.2 1.1 0 0 1 1.2 1.1 1.2 1.1 0 1 1-2.4 0 1.2 1.1 0 0 1 1.2-1.1z"></path>
        </g>
      </svg>
    );
  }
