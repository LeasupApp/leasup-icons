        ...
        <g transform="translate(0 26.7) scale(1.06667)">
          ...
          <g id="e">
            <g id="d" fill="#ff0" stroke="#000" strokeWidth=".5">
              ...
              <use href="#a" width="100%" height="100%" x="10.6"></use>
              <path
                id="b"
                d="M186.3 139h1.2v1h.9v-1h1.2v1h.9v-1h1.2v2c0 .4-.2.6-.5.6h-4.3a.6.6 0 0 1-.6-.6v-2z"
              ></path>
              <use href="#b" width="100%" height="100%" x="10.6"></use>
              <path
                fill="#000"
                stroke="none"
              ...
              ></path>
              <use href="#c" width="100%" height="100%" x="10.6"></use>
            </g>
            <use href="#d" width="100%" height="100%" y="46.3"></use>
            <use
              href="#d"
              width="100%"
              height="100%"
          ...
          <use href="#d" width="100%" height="100%" x="45.7"></use>
          <use
            href="#e"
            width="100%"
            height="100%"
          ...
          <use href="#f" width="100%" height="100%" y="-26"></use>
          <use href="#f" width="100%" height="100%" x="-20.8"></use>
          <use href="#f" width="100%" height="100%" x="20.8"></use>
          <use href="#f" width="100%" height="100%" y="25.8"></use>
        </g>
      </svg>
    );
  }
