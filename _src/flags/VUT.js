  ...
  ({ color = 'currentColor', size = 32, ...rest }, ref) => {
    return (
      ...
      >
        <defs>
          <clippath id="a">
            <path d="M0 0v475l420-195h480v-85H420Z"></path>
          </clippath>
        </defs>
        <path fill="#009543" d="M0 0h640v480H0z"></path>
        <path fill="#d21034" d="M0 0h640v240H0z"></path>
        ...
        <g fill="#fdce12" transform="translate(-22) scale(1.01053)">
          <path d="M106.9 283v27c23.5 0 69.7-18 69.7-76.1 0-58.1-49.3-68.9-64-68.9-14.8 0-60.3 10.6-60.3 58 0 47.6 44.7 52 53.5 52 8.8 0 41.8-8 38-43.6a35.5 35.5 0 0 1-35.4 31.5c-24 0-39-17.8-39-35.4 0-17.6 14.6-41.2 39.9-41.2 25.3 0 43.8 22.5 43.8 45.1 0 22.7-17.8 51.5-46.2 51.5z"></path>
          <g id="b">
            <path
              stroke="#fdce12"
              strokeWidth=".8"
