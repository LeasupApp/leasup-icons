  ...
  ({ color = 'currentColor', size = 32, ...rest }, ref) => {
    return (
      <svg
        ...
        {...rest}
      >
        <path fill="#e32118" d="M0 0h640v480H0z"></path>
        <path fill="#fff" d="M0 0h640v320H0z"></path>
        <path fill="#3e9a00" d="M0 0h640v160H0z"></path>
        <path fill="#0073ce" d="M0 0v480l180-240z"></path>
        <g stroke="#000">
          <path
            fill="#fff"
          ...
          <g fill="#fff" strokeWidth=".7">
            <path d="m365.4 270.4 5 7.2 4.6-6.8-3.2-5.8zm-31.8 21 .4 7.2s2 0 3.8-.6c1.6-.6 3-1.8 3-1.8l-.2-3.8zm-26.8 0-.4 7s-1.8 0-3.6-.4c-1.6-.4-3-1.4-3-1.4l-2-4.8zm-32.2-21-5.2 7.2-5.6-9.2 4.2-4.4z"></path>
            <path d="M299.6 305.8c0 6.8 41.2 6.8 41.2 0v-9.6c0 5-41.2 4-41.2 0z"></path>
            ...
            <path d="M265.4 276.6c-9.2-5-2-10.2-1.2-25 1.4 9 11.6 12.8 10.4 18.6-4.2.2-6.2-6.2-8.2.8l-1 5.6zm109.4 0c9.2-5.2 1.6-10.2.8-25-1.4 9-11.4 12.8-10.2 18.6 4 .2 6-6.2 8 .8l1.4 5.4z"></path>
          </g>
          <path
            stroke="none"
