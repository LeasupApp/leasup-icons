    ...
    return (
      ...
      >
        <defs>
          ...
          >
            <stop offset="0" stopColor="#510000"></stop>
            <stop offset=".3" stopColor="#8a0000"></stop>
            <stop offset="1" stopColor="#a00"></stop>
          </lineargradient>
          <lineargradient
            id="g"
            x1="501.4"
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop offset="0" stopColor="#ff2a2a"></stop>
          ...
          <lineargradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop offset="0" stopColor="#F5F549"></stop>
            <stop offset="1" stopColor="#97C924"></stop>
          </lineargradient>
          <lineargradient id="a">
            <stop offset="0" stopColor="#025"></stop>
            <stop offset=".5" stopColor="#04a"></stop>
            <stop offset="1" stopColor="#025"></stop>
          </lineargradient>
          <lineargradient
            href="#a"
            id="h"
          ...
          ></lineargradient>
          <clippath id="c">
            <path d="m500 226.4-63.7 110.3h127.4z"></path>
          </clippath>
        </defs>
        <path fill="#0067c6" d="M0 0h640v480H0z"></path>
        ...
        <g clipPath="url(#c)" transform="matrix(.8 0 0 .8 -80 0)">
          ...
          <g id="e">
            <g id="d">
              <path
                ...
                opacity=".6"
              ></path>
              <path fill="#fff" d="M500 277.5h-.1l.1 3 .1-3h-.1z"></path>
            </g>
            <use
              href="#d"
              width="100%"
          ...
          <g fill="#ccd11e">
            ...
            <use href="#t" width="100%" height="100%" x="-15.3"></use>
            <g fill="#c6cb24">
              <path
                fill="url(#u)"
              ...
              ></path>
              <path d="M499.3 298.9c-.4 6-2.3 13.2-6.7 17.8-1.6 1.3-3.6 2.6-5.6 2.3 6.8-5.5 10.9-14 12.3-20.1z"></path>
              <path
                fill="#9ecb34"
              ...
              ></path>
              <path d="M501.5 298.9c.4 6 2.2 12 6.6 16.6 1.6 1.4 3.6 2.6 5.6 2.3a31.1 31.1 0 0 1-12.2-18.9z"></path>
            </g>
            <g id="w">
              <path
                fill="url(#v)"
              ...
              ></path>
              <path d="M485.4 298.9c.5 6 2.3 13.2 6.7 17.8 1.6 1.3 3.6 2.6 5.6 2.3a38.5 38.5 0 0 1-12.3-20.1z"></path>
              <path
                fill="#9ecb34"
          ...
          <g id="A">
            ...
            ></path>
            <use href="#z" width="100%" height="100%" y="-1.3"></use>
            <use href="#z" width="100%" height="100%" y="-2.6"></use>
          </g>
          <use href="#A" width="100%" height="100%" y="-3.9"></use>
          <use href="#A" width="100%" height="100%" y="-7.7"></use>
          <path
            fill="#97c924"
